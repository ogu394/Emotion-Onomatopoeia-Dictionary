...
class EmotionObject{
    ...
    getHtmlContainerString(){
        ...
        let containerSection = `<div class="col-12 p-5 container " style="background-color:${this.color}">`;

        containerSection +=
            `
            <div id="${this.emotion}">
                <div class="col-10 text-white">
                    <h2 class="text-uppercase">${this.emotion}</h2>
        ...
        for(let i = 0; i < cards.length; i++){
            ...
            containerSection += 
                `   
                        <div class = "mt-4 mr-2 p-2 bg-white d-flex align-items-center col-12  col-md-5 col-lg-3">
                            <div class="col-6">
                                <h4 class="mb-2">${currentCard.word}</h4>
                                <p>${currentCard.defintion}</p>
                            </div>
                            <div class="col-6">
                                <img class="img-fluid" src=${currentCard.pictureUrl}>
                            </div>
                        </div>    
...
const categoryImages = {
    "angry":"https://images.pexels.com/photos/693785/pexels-photo-693785.jpeg",
    "happy":"https://images.pexels.com/photos/977971/pexels-photo-977971.jpeg",
    "bad":"https://images.pexels.com/photos/5723268/pexels-photo-5723268.jpeg",
    "sad":"https://images.pexels.com/photos/679438/pexels-photo-679438.jpeg",
    "surprised":"https://images.pexels.com/photos/3784324/pexels-photo-3784324.jpeg",
    "fearful":"https://images.pexels.com/photos/6045593/pexels-photo-6045593.jpeg",
    "disgusted":"https://images.pexels.com/photos/5051722/pexels-photo-5051722.jpeg",
...
for (let i = 0; i < emotions.length; i++){
    ...
    `
            <div class="col-12 col-sm-6 col-md-4  ">
                <div class="p-3 my-2 " style="background-color:${currentEmotion.color}">
                    <a class="text-white  text-uppercase" href="#${currentEmotion.emotion}"><h4>${currentEmotion.emotion}</h4></a>
                    <img class ="img-fluid" src="${categoryImages[currentEmotion.emotion]}">
                </div>
            </div>
    `;
}
...
let emotionDictionary = document.getElementById("target");

emotionDictionary.innerHTML += category;


emotions.map(emotion => emotionDictionary.innerHTML += emotion.getHtmlContainerString());